...
$titulo = 'Solicitar Ride';
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){ 
    ...
    if(($titulo=='')||($telefono=='')||($direccion=='')||($descripcion=='')||($fecha=='')||($hora==''||($espacios==''))){
     ...
     $publicacion_model->insertSolicitud( $idUsuario, $fecha,$titulo, $descripcion, $telefono,$direccion,$tipo,$hora,$espacios,$provincia,$fechapP);
      echo " <script type='text/javascript'>
...
<body>
<div id="publicar">
  <h2 id="tittlePubli">Solicita tu ride aquí</h2>
  <br>
  <div id="form">
  ...
  <tr>
    <td><label>Fecha en la que buscas ride: </label></td>
  ...
  <tr>
   ...
   <tr>
    <td><label>Espacios que necesitas: </label></td>
...
<?php 
$result_array = $publicacion_model->indexSolicitudes($search);
  ...
  echo "<h5>".$row['hora'] ."</h5>";
  echo "<label>Espacios necesarios: </label>";
